...
const Navbar = () => {
  ...
  return (
  <div className={`fixed top-0 left-0 z-[99] w-full ${theme?' bg-gradient-to-r from-[#0b0b0b] via-[#383838] to-[#060606]':'bg-slate-50'}`}>
    <div className={`flex px-3 py-3 justify-between sm:px-10 sm:py-5 items-center`}>
        ...
        {data?(
          <div className="flex">
            ...
            <div>
              <Link to='/logout'>
                <button className={`px-4 py-1 mr-2 border-[#7878bc] ${theme?'text-white  shadow-[#7878bc] hover:shadow-[#7878bc]':'bg-[#7878bc] shadow-[#24243b] text-[#ffffff] hover:shadow-[#24243b]'} rounded-md  border-[1.6px]  shadow-sm hover:shadow-md `} onClick={handleLogout} >Log out</button>
              </Link>
            </div>
          </div>
        ):(
